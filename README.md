**This branch generates *Extended Data Fig. 9 panel b*, which is presented in "Gain control of sensory input across polysynaptic circuitries in visual cortex
